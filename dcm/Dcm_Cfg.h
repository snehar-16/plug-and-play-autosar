...
/* --------------------------------------------------------------------------
 * UNIFIED MASTER DID & EVENT TABLE (No Overlap)
 * -------------------------------------------------------------------------- */

/* --- Session 1: System Faults (0xF1xx) [Default Session] --- */
...
/* --- Session 3: Operational Audit / SOS (0xF2xx) [Extended Session] --- */
...
/* --- Session 2: Configuration & Write (0xF3xx) [Programming Session] --- */
